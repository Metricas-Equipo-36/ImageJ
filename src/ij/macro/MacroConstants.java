...
public interface MacroConstants {
    ...
    int TABLE=4000, ROI=4001, ROI_MANAGER2=4002, PROPERTY=4003, IMAGE=4004, COLOR=4005;
	String[] variableFunctions = {"Table", "Roi", "RoiManager", "Property", "Image", "Color"};
	int[] variableFunctionIDs = {TABLE, ROI, ROI_MANAGER2, PROPERTY, IMAGE, COLOR};
